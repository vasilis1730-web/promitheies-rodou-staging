...
> **Ενημέρωση 2026-08-28:** Η διαδρομή αυτού του εγγράφου **δεν ακολουθήθηκε**.
> Το staging project γίνεται το παραγωγικό και δεν μεταφέρονται δεδομένα.
> Βλ. `docs/GO_LIVE_DECISION.md`. Το παρόν παραμένει ως τεκμηρίωση για
> ενδεχόμενη μελλοντική μεταφορά ιστορικού.
